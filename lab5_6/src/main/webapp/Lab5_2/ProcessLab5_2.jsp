...
<%@page import="Lab5_1.User"%>
<%@page import="Lab5_1.UserService"%>
...
<body>
	...
	User user = new User((String) username, (String) pass);
	UserService userService = new UserService(user);

	if (username.length() >= 10 && username.length() <= 40 && pass.length() >= 8 && userService.check(username, pass)) {
